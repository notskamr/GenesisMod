package skamr.genesis.blocks.TileEntities;
...
import skamr.genesis.blocks.MachineBlocks.IronFurnace.IronFurnaceRecipes;
import skamr.genesis.blocks.MachineBlocks.IronFurnace.slots.SlotIronFurnaceFuel;
...

{
	...
	public void setInventorySlotContents(int index, ItemStack stack) 
	{
		  ...
		  public void update()
		    {
		        ...
		        if (!this.world.isRemote)
		        {
		            ...
		            if (this.isActive() || !itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(0)).isEmpty())
		            {
		            ...
		            {
		                flag1 = true;
		                IronFurnace.setState(this.isActive(), this.world, this.pos);
		            }
		        }
		...
		private boolean canSmelt()
	    {
	        ...
	        {
	            ItemStack itemstack = IronFurnaceRecipes.instance().getCookingResult(this.furnaceItemStacks.get(0));
		...
		public void smeltItem()
	    {
	        if (this.canSmelt())
	        {
	            ...
	            ItemStack itemstack1 = IronFurnaceRecipes.instance().getCookingResult(itemstack);
		  ...
		  public void openInventory(EntityPlayer player)
		    ...
		    public boolean isItemValidForSlot(int index, ItemStack stack) 
		    {
		    	...
		    	else if(index != 1)
		    	{
		    		...
		    		ItemStack itemStack = this.furnaceItemStacks.get(1);
		    		return isItemFuel(stack) || SlotIronFurnaceFuel.isBucket(stack)  && itemStack.getItem() != Items.BUCKET;
		    	}
		    }
		    ...
		    {
		    	return "genesis:electric_furnace";
		    }
		    @Override
		    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) 
		    {
		    	return new IronFurnaceContainer(playerInventory, this);
		    }
