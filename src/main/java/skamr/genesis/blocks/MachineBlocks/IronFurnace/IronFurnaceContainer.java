...
import skamr.genesis.blocks.MachineBlocks.IronFurnace.slots.SlotIronFurnaceOutput;
...
public class IronFurnaceContainer extends Container
{
	...
	public IronFurnaceContainer(InventoryPlayer playerInventory, IInventory furnaceInventory) 
	{
		this.tileFurnace = furnaceInventory;
		this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 17));
		this.addSlotToContainer(new SlotIronFurnaceFuel(furnaceInventory, 1, 56, 53));
		this.addSlotToContainer(new SlotIronFurnaceOutput(playerInventory.player, furnaceInventory, 2, 116, 35));
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) 
	{
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (!IronFurnaceRecipes.instance().getCookingResult(itemstack1).isEmpty())
                {
