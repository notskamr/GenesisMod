...
public class IronFurnace extends BlockContainer implements IHasModel
{
	...
	public IronFurnace(String name, boolean isActive) {
		super(Material.IRON);
	...
	public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, ModBlocks.IRON_FURNACE_ON.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.IRON_FURNACE_ON.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, ModBlocks.IRON_FURNACE_OFF.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.IRON_FURNACE_OFF.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) 
	{
		if(!keepInventory)
		{
			...
			TileEntityIronFurnace tileentity = (TileEntityIronFurnace)worldIn.getTileEntity(pos);
	...
	{
		return new ItemStack(ModBlocks.IRON_FURNACE_OFF);
	}
	@Override
